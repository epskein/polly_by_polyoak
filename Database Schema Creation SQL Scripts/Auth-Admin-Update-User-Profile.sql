-- Admin function to update a user's profile and email in a single call
-- Fields: email, first_name, last_name, phone, role_id
...
revoke all on function public.admin_update_user_profile(uuid, text, text, text, text, uuid) from public;
